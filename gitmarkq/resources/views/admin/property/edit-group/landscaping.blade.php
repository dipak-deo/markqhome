...
@section('title','Display Property LandScaping')
@section('page_title','Display Property LandScaping')
@section('body')
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Landscaping of {{ $property->title }}</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="" rows="10" cols="30" required>{{ old('description') }}</textarea>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="" rows="10" cols="30" required>{{ $edit_data->description }}</textarea>
                        </div>
                        @error('description') <p class="text-danger"> {{ $message }}</p> @enderror
                    </div>
                    <div class="col-md-12">
