...
@section('title','Display Upgrate Type ')
@section('page_title','Display Upgrate Type ')
@section('body')
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Upgrate types {{ $property->title }}</h4>
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                {{-- @php(dd($data->description)) --}}
                                <ul>
                                @foreach($data->description as $m)
                                {{-- @php(dd($data->description)) --}}
                                    <li>{{ $m['title'] }}</li>
                                @endforeach
                                </ul>
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="custom_url_create_modelLabel">Create Upgate Type</h5>
         
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
        </div>
        <form action="{{ route('admin.property.update.group',['edit_type'=>$edit_type,'id'=>$property->id]) }}" method="post">
            @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 property_upgrade_create_section">
                        <div class="form-group">
                            <label for="" class="col-form-label form-label">Meta Data</label>
                        </div>
                        <table class="table table-bordered property_upgrade_create">
                            <thead>
                                <th>SN</th>
                                <th>Title</th>
                                <th>Description</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                        <input type="text" class="form-control" name="meta_key[]" placeholder="eg: water">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                        <textarea name="meta_value[]" id="" class="form-control" cols="30" rows="10" required placeholder="write details"></textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                        <input type="number" class="form-control" name="price_key[]" placeholder="eg: 2000" required>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
...
<div class="modal fade" id="custom_url_edit_model" tabindex="-1" role="dialog" aria-labelledby="custom_url_edit_modelLabel" aria-hidden="true">
    <div class="modal-dialog  modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="custom_url_edit_modelLabel">Edit Upgtae Types</h5>
                    ...
                    <div class="col-md-12 property_upgrade_create_section">
                        ...
                        <table class="table table-bordered property_upgrade_create">
                            ...
                            <tbody>
                                ...
                                @else
                                @foreach($edit_data->description as $dkey=>$desc)
                                <tr>
                                    <td class="sn">{{ ++$dkey }}</td>
                                    <td>
                                        <input type="hidden" name="uuid[]" value="{{ $desc['uuid'] }}">
                                        <div class="form-group">
                                        <input type="text" class="form-control" name="meta_key[]" placeholder="eg: water" value="{{ $desc['title'] ?? '' }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                        <textarea name="meta_value[]" id="" class="form-control" cols="30" rows="10" required placeholder="write details">{{ $desc['description'] ?? '' }}</textarea>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                        <input type="number" class="form-control" name="price_key[]" placeholder="eg: 2000" required value="{{ $desc['price'] ?? '' }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
...
<script>
     js_colum_colne('property_upgrade_create','btn-add','btn-remove','sn');
</script>
<script>
