...
@section('title','Display Property Floor plan')
@section('page_title','Display Property Floor plan')
@section('body')
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Flooor Plan of {{ $property->title }}</h4>
        ...
        <form action="{{ route('admin.property.update.group',['edit_type'=>$edit_type,'id'=>$property->id]) }}" method="post">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="" class="col-form-label form-label">Upgrate Type</label>
                            <input type="text" class="form-control" name="upgrate_type" value="{{ old('upgrate_type') }}" required>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="" class="col-form-label form-label">Squre Feet</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="beds" value="{{ old('beds') }}" required>
                            </div>
                            @error('upgrate_type') <p class="text-danger"> {{ $message }}</p> @enderror
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="" class="col-form-label form-label">Garage</label>
                                <input type="text" class="form-control" name="garage" value="{{ old('garage') }}" required>
                            </div>
                            @error('upgrate_type') <p class="text-danger"> {{ $message }}</p> @enderror
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lot_width" value="{{ old('lot_width') }}" required>
                            </div>
                            @error('upgrate_type') <p class="text-danger"> {{ $message }}</p> @enderror
                        </div>
                    <div class="col-md-12">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="" class="col-form-label form-label">Upgrate Type</label>
                            <input type="text" class="form-control" name="upgrate_type" value="{{ $edit_data->upgrate_type }}" required>
                        </div>
                        @error('upgrate_type') <p class="text-danger"> {{ $message }}</p> @enderror
                    </div>
                    {{-- ------------------------------------------ --}}
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="" class="col-form-label form-label">Squre Feet</label>
                            <input type="text" class="form-control" name="area" value="{{ $edit_data->area }}" required>
                        </div>
                        @error('upgrate_type') <p class="text-danger"> {{ $message }}</p> @enderror
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="" class="col-form-label form-label">Beds</label>
                            <input type="text" class="form-control" name="beds" value="{{ $edit_data->beds }}" required>
                        </div>
                        @error('upgrate_type') <p class="text-danger"> {{ $message }}</p> @enderror
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="" class="col-form-label form-label">Bath</label>
                            <input type="text" class="form-control" name="bath" value="{{ $edit_data->bath }}" required>
                        </div>
                        @error('upgrate_type') <p class="text-danger"> {{ $message }}</p> @enderror
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="" class="col-form-label form-label">Garage</label>
                            <input type="text" class="form-control" name="garage" value="{{ $edit_data->garage }}" required>
                        </div>
                        @error('upgrate_type') <p class="text-danger"> {{ $message }}</p> @enderror
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="" class="col-form-label form-label">Lot Width</label>
                            <input type="text" class="form-control" name="lot_width" value="{{ $edit_data->lot_width }}" required>
                        </div>
                        @error('upgrate_type') <p class="text-danger"> {{ $message }}</p> @enderror
                    </div>
                    <div class="col-md-12">
