...
@section('title','Display Inclusive ')
@section('page_title','Display Inclusive ')
@section('body')
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Inclusive of {{ $property->title }}</h4>
...
<div class="modal fade" id="custom_url_edit_model" tabindex="-1" role="dialog" aria-labelledby="custom_url_edit_modelLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="custom_url_edit_modelLabel">Edit Inclusive </h5>
