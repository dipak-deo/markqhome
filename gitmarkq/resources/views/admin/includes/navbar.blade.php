<div id="header" class="app-header">
    ...
    <div class="navbar-header">
        <a href="{{ route('admin.index') }}" class="navbar-brand"><span class="navbar-logo"></span> <b class="me-3px">IB</b>
            Admin</a>
    ...
    <div class="navbar-nav">
        ...
        <div class="navbar-item navbar-user dropdown">
            <a href="#" class="navbar-link dropdown-toggle d-flex align-items-center"
                ...
                @endif
                <span>
                    <span class="d-none d-md-inline">{{ Auth::user()->first_name ?? 'n/a' }} {{ Auth::user()->last_name ?? '' }}</span>
                    <b class="caret"></b>
                </span>
            </a>
