...
@section('title','Display Home Section')
@section('page_title','All Home Section')
@section('body')
            ...
            <div class="panel-body">
                <table id="data-table-default"
                    ...
                    <tbody>
                        ...
                        @foreach(config('register')['home-section'] as $data)
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.home.section.edit',$data['slug']) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
