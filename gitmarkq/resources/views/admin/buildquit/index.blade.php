...
@section('title','Display Build Quits')
@section('page_title','All Build Quits')
@section('body')
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Table - Build Quits</h4>
                ...
                <table id="data-table-default"
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td> 
                                $ {{ (get_buildquit_meta($data->id,'total_amount'))? get_buildquit_meta($data->id,'total_amount')->meta_value :'-' }}
                            </td>
                            <td> 
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.build.quit.show',$data->id) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
