...
@section('title','Display Contact')
@section('page_title','All Contact')
@section('body')
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h4 class="panel-title">Table - Contact</h4>
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.contact.show',$data->id) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
